...
export default function ImageDownload(props) {
  ...
  return (
    <div
      className="img-download-container"
      style={{ borderBottom: props.borderFlag ? "1px solid #9e9e9ea8" : "" }}
    >
      <div className="download-title">
        {props.imageFlag ? (
          <img className="new-img" src={newImg} alt="new" />
        ) : (
          ""
        )}
      ...
      <button className="download-btn" on onClick={openDownloadPopup}>
        {props.btnText}
      </button>
